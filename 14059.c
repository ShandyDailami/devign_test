...

{
    ...
    char proto[8], host_address_var[256], path[1024], auth[100], *fname;
    ...
    av_url_split(proto, sizeof(proto), auth, sizeof(auth),
                 ...
                 host_address_var, sizeof(host_address_var), &port,
    ...
    if (!strcmp(proto, "rtmpt") || !strcmp(proto, "rtmpts")) {
        ...
        ff_url_join(buf, sizeof(buf), "ffrtmphttp", NULL, host_address_var, port, NULL);
        ...
        ff_url_join(buf, sizeof(buf), "tls", NULL, host_address_var, port, NULL);
        ...
        ff_url_join(buf, sizeof(buf), "ffrtmpcrypt", NULL, host_address_var, port, NULL);
        ...
        if (rt->listen)
            ...
            ff_url_join(buf, sizeof(buf), "tcp", NULL, host_address_var, port,
            ...
            ff_url_join(buf, sizeof(buf), "tcp", NULL, host_address_var, port, NULL);
...
reconnect:
    ...
    if (!rt->tcurl) {
        ...
        ff_url_join(rt->tcurl, TCURL_MAX_LENGTH, proto, NULL, host_address_var,
