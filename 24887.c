...

{
    ...
    char host_address_var[1024], localaddr[1024] = "";
    ...
    av_url_split(NULL, 0, NULL, 0, host_address_var, sizeof(host_address_var), &port, NULL, 0, uri);



    /* XXX: fix av_url_split */

    if (host_address_var[0] == '\0' || host_address_var[0] == '?') {

        /* only accepts null host_address_var if input */
