...

{
    ...
    if (!strcmp(device, "user")) {
        ...
        static const char * const slirp_params[] = {
            ...
            "vlan", "name", "host_address_var", "restrict", "ip", "net", "host",
        ...
        if (get_param_value(buf, sizeof(buf), "host_address_var", p)) {

            vhost_address_var = qemu_strdup(buf);
        ...
        ret = net_slirp_init(mon, vlan, device, name, restricted, vnet, vhost,
                             ...
                             vhost_address_var, tftp_export, bootfile, vdhcp_start,
