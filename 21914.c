...

{
    ...
    char proto[10], path[MAX_URL_SIZE], host_address_var[1024], credencials[1024];
    ...
    av_url_split(proto, sizeof(proto),
                 ...
                 host_address_var, sizeof(host_address_var),
    ...
    ssh_options_set(s->session, SSH_OPTIONS_HOST, host_address_var);
